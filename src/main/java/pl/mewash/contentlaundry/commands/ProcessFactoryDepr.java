...
//                "--print-to-file", "%(upload_date)s ||| %(title)s ||| %(webpage_url)s ||| %(id)s", tempFile.toAbsolutePath().toString(),
//                channelUrl
//        ));
...
//                "--quiet",
////                "--print", "%(channel)s",
//                "--print-to-file", "%(channel)s", tempFile.toAbsolutePath().toString(),
//                channelUrl
//        ));
//
//        return new ProcessBuilder(command);
...
//            command.addAll(List.of(
//                    "--extract-audio",
//                    "--audio-format", format.fileExtension,
//                    "--audio-quality", "0"
//            ));
//        } else if (format == Formats.MP4) {
//            command.addAll(List.of(
////                    "-f", "bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4", // cause low quality downloads if 4k available
//                    "-f", "bv[height>=1080][ext=mp4]+ba[acodec^=mp4a]/bestvideo+bestaudio/best",
//                    "--merge-output-format", format.fileExtension
//            ));
